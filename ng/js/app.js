    ...
    .controller('WPCFSForm', ['$scope', 'i18n', function ($scope, i18n) {
        ...
        var update_child_config = function () {
            $scope.config = {
                ...
                "building_blocks": $scope.$parent.config.building_blocks,
                "settings_pages": $scope.$parent.config.settings_pages,
                "save_callback": $scope.$parent.config.save_callback,
                "delete_callback": $scope.$parent.config.delete_callback,
                "export_callback": $scope.$parent.config.export_callback,
                "save_nonce": $scope.$parent.config.save_nonce,
                "delete_nonce": $scope.$parent.config.delete_nonce,
                "export_nonce": $scope.$parent.config.export_nonce
            };
        };
